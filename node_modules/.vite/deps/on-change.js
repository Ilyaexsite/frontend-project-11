...
// node_modules/on-change/source/constants.js
var PATH_SEPARATOR = ".";
var TARGET = Symbol("target");
var UNSUBSCRIBE = Symbol("unsubscribe");

// node_modules/on-change/source/is-builtin.js
...
function isBuiltinWithoutMutableMethods(value) {
  return value === null || typeof value !== "object" && typeof value !== "function" || value instanceof RegExp;
}

// node_modules/on-change/source/is-symbol.js
function isSymbol(value) {
  return typeof value === "symbol";
}

// node_modules/on-change/source/path.js
var path = {
  after(path2, subPath) {
...
// node_modules/on-change/source/is-iterator.js
function isIterator(value) {
  return value !== null && typeof value === "object" && typeof value.next === "function";
}

// node_modules/on-change/source/wrap-iterator.js
function wrapIterator(iterator, target, thisArgument, applyPath, prepareValue) {
  const originalNext = iterator == null ? void 0 : iterator.next;
...
// node_modules/on-change/source/ignore-property.js
...
// node_modules/on-change/source/cache.js
var Cache = class {
  constructor(equals) {
    this._equals = equals;
    this._proxyCache = /* @__PURE__ */ new WeakMap();
    this._pathCache = /* @__PURE__ */ new WeakMap();
    this._allPathsCache = /* @__PURE__ */ new WeakMap();
  ...
  _pathsEqual(pathA, pathB) {
    ...
    return pathA.length === pathB.length && pathA.every((part, index) => part === pathB[index]);
  }
  _getDescriptorCache() {
  ...
  getProxy(target, path2, handler, proxyTarget) {
    ...
    const reflectTarget = proxyTarget === void 0 ? void 0 : target[proxyTarget];
    ...
    const pathExists = allPaths.some((existingPath) => this._pathsEqual(existingPath, path2));
    if (!pathExists) {
      allPaths.push(path2);
    }
...
// node_modules/on-change/source/is-array.js
var is_array_default = Array.isArray;

// node_modules/on-change/source/smart-clone/diff/is-diff-certain.js
function isDiffCertain() {
  return true;
}

// node_modules/on-change/source/smart-clone/diff/is-diff-arrays.js
...
// node_modules/on-change/source/smart-clone/methods/object.js
...
// node_modules/on-change/source/smart-clone/methods/array.js
...
// node_modules/on-change/source/smart-clone/diff/is-diff-sets.js
...
// node_modules/on-change/source/smart-clone/methods/set.js
...
// node_modules/on-change/source/smart-clone/diff/is-diff-maps.js
...
// node_modules/on-change/source/smart-clone/methods/map.js
...
// node_modules/on-change/source/smart-clone/clone/clone-object.js
...
// node_modules/on-change/source/smart-clone/clone/clone-array.js
...
// node_modules/on-change/source/smart-clone/clone/clone-date.js
...
// node_modules/on-change/source/smart-clone/clone/clone-set.js
...
// node_modules/on-change/source/smart-clone/clone/clone-map.js
...
// node_modules/on-change/source/smart-clone/clone/clone-weakset.js
...
// node_modules/on-change/source/smart-clone/clone/clone-weakmap.js
...
// node_modules/on-change/source/smart-clone/smart-clone.js
...
// node_modules/on-change/source/index.js
var ITERATOR_METHOD_NAMES = /* @__PURE__ */ new Set(["values", "keys", "entries"]);
var ARRAY_SEARCH_METHODS = /* @__PURE__ */ new Set(["indexOf", "lastIndexOf", "includes"]);
var defaultOptions = {
  equals: Object.is,
  isShallow: false,
  pathAsArray: false,
...
var shouldProvideApplyData = (details, methodName) => details === false || details === true || Array.isArray(details) && details.includes(methodName);
var onChange = (object, onChange2, options = {}) => {
  ...
  const handleChangeOnTarget = (target, property, value, previous, applyData) => {
    ...
    const pathsToNotify = !smartClone.isCloning && allPaths && allPaths.length > 1 ? allPaths : [cache.getPath(target)];
  ...
  const getProxyTarget = (value) => value !== null && (typeof value === "object" || typeof value === "function") ? value[proxyTarget] ?? value : value;
  ...
  const handleMethodExecution = (target, thisArgument, thisProxyTarget, argumentsList) => {
    ...
    if ((thisArgument instanceof Map || thisArgument instanceof Set) && isIterator(result)) {
  ...
  const handler = {
    ...
    defineProperty(target, property, descriptor) {
      if (!cache.isSameDescriptor(descriptor, target, property)) {
        ...
        if (validate(target, property, descriptor.value, previous) && cache.defineProperty(target, property, descriptor)) {
          const hasValue = Object.hasOwn(descriptor, "value");
          const value = hasValue ? descriptor.value : (() => {
            try {
    ...
    apply(target, thisArgument, argumentsList) {
      const thisProxyTarget = (thisArgument == null ? void 0 : thisArgument[proxyTarget]) ?? thisArgument;
      if (cache.isUnsubscribed) {
        return Reflect.apply(target, thisProxyTarget, argumentsList);
      }
      if (SmartClone.isHandledType(thisProxyTarget)) {
        const isPlainObjectCustomMethod = isObject(thisProxyTarget) && !SmartClone.isHandledMethod(thisProxyTarget, target.name);
        if (!isPlainObjectCustomMethod) {
          const isInternalMethod = typeof target.name === "symbol" || ITERATOR_METHOD_NAMES.has(target.name);
          const shouldUseSmartClone = isInternalMethod || details === false || Array.isArray(details) && !details.includes(target.name);
      ...
      if (thisProxyTarget instanceof Date && SmartClone.isHandledMethod(thisProxyTarget, target.name)) {
        ...
        if (!equals(previousTime, currentTime)) {
          ...
          if (shouldProvideApplyData(details, target.name)) {
            ...
            if (validate(path_default.get(object, applyPath), "", thisProxyTarget, previousDate, applyData)) {
...
var performProxyAwareArraySearch = (options) => {
  ...
  let startIndex = fromIndex === void 0 ? isLastIndexOf ? length - 1 : 0 : Math.trunc(Number(fromIndex)) || 0;
  if (startIndex < 0) {
